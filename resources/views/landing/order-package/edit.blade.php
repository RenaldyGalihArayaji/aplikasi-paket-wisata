    ...
    <section id="order" class="my-5">
      <div class="container mt-5 p-5">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            <div class="pt-4 border shadow">
              <h5 class="text-center"><strong>ID Order : {{ $orderPackage->code_order }}</strong></h5>
            </div>
          </div>

          <div class="col-md-6 mb-3">
            <div class="pt-4 border shadow">
              <h5 class="text-center"><strong>Total Pembayaran : @currency($orderPackage->amount)</strong></h5>
            </div>
          </div>
        ...
        <div class="row mt-5 shadow border p-4">
          ...
          <div class="col-md-6">
            <form action="{{ route('order-package.update', $orderPackage->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
